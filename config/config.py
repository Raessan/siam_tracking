...
DINO_MODEL_WEIGHTS = "/home/rafa/deep_learning/projects/siam_tracking/results/dinov3_vits16plus_pretrain_lvd1689m-4057cbaa.pth"
PROJ_DIM = 512
...
RESULTS_PATH = 'results' # Folder where the result will be saved
